...
// Source: ./little-book/pkg/limiter/types.go
//
// Generated by this command:
//
//	mockgen -source=./little-book/pkg/limiter/types.go -package=limitermocks -destination=./little-book/pkg/limiter/mocks/limiter.mock.go
//
