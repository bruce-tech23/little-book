...
// Source: ./little-book/internal/service/user.go
//
// Generated by this command:
//
//	mockgen -source=./little-book/internal/service/user.go -package=svcmocks -destination=./little-book/internal/service/mocks/user.mock.go
//
