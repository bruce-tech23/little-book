...
// Source: ./little-book/internal/repository/user.go
//
// Generated by this command:
//
//	mockgen -source=./little-book/internal/repository/user.go -package=repomocks -destination=./little-book/internal/repository/mocks/user.mock.go
//
