...
// Source: ./little-book/internal/repository/code.go
//
// Generated by this command:
//
//	mockgen -source=./little-book/internal/repository/code.go -package=repomocks -destination=./little-book/internal/repository/mocks/code.mock.go
//
